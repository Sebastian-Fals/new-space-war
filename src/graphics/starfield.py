...
class Starfield:
    def __init__(self, width, height):
        ...
        v_path = os.path.join(base_path, 'assets', 'shaders', 'starfield.vert')
        f_path = os.path.join(base_path, 'assets', 'shaders', 'modern_space.frag')
